...
GLfloat vertices[]	= {  20.1f,-1.5f, 20.1f,	-20.1f,-1.5f, 20.1f,	-20.1f,-1.5f,-20.1f,	20.1f,-1.5f,-20.1f};
...
void Main_Loop(void){
	...
	float Pose[] = {  0.0f,  0.0f,  5.0f};
	float View[] = {  0.0f,  0.5f,  9.0f}; 
	float Upvx[] = {  0.0f,  1.0f,  0.0f};
	
	float aspect_ratio = ((float)600) / 800;

	Camera.SetProjection( &Camera, 0.5f, -0.5f, -0.5f * aspect_ratio, 0.5f * aspect_ratio, 1.25f, 50.0f);	// NEW SHIT
